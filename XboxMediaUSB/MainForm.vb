...
Public Class MainForm
    ...
    Private Sub FormatWorker_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles FormatWorker.RunWorkerCompleted
        ...
        If MsgBox("Do you want to create the 'Games' and 'RetroArch' folders on your new drive?", MsgBoxStyle.YesNo, "Directories") = MsgBoxResult.Yes Then
            ...
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Atari")
            ...
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\DS")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\GameBoy")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\GameBoyColor")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\GameBoyAdvance")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\GameCube")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\N64")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\NES")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\SuperNintendo")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Nintendo\Wii")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Playstation")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Playstation\PS1")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Playstation\PS2")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Playstation\PSP")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Sega")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Sega\Dreamcast")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Sega\GameGear")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Sega\Genesis-MegaDrive")
            Directory.CreateDirectory(SelectedDrive.Name + "Games\Sega\MasterSystem")
